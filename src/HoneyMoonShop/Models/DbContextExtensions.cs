namespace HoneymoonShop.Models
{
    public static class DbContextExtensions
    {
        ...
        private static void AddJurk(HoneyMoonShopContext context)
        {
            Jurk jurk;
            context.AddRange(
                 jurk = new Jurk() { Artikelnummer = 12649, Merk = "Ladybird", Omschrijving = "Trouwjurk van het merk Ladybird gemaakt van kant. De top is strapless met een sweetheart lijn. De rok heeft een A-lijn met een sleep.", MinPrijs = 1500, MaxPrijs = 1750, Neklijn = "Strapless", Silhouette = "A-lijn", Stijl = "Kant" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12649a" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12649b" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12649c" },

                 jurk = new Jurk { Artikelnummer = 12810, Merk = "Diane Legrand", Omschrijving = "Trouwjurk van het merk Diane Legrand gemaakt van kant. De top heeft een hoge doorzichtige neklijn en een laag uitgesneden rug, afgewerkt met beading. De rok is wijdvallend met een sleep.", MinPrijs = 1250, MaxPrijs = 1500, Neklijn = "Hoge neklijn", Silhouette = "Princess model", Stijl = "Prinses Bruid" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12810a" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12810b" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12810c" },

                 jurk = new Jurk { Artikelnummer = 12746, Merk = "Pronovias", Omschrijving = "Trouwjurk van het merk Pronovias gemaakt van kant. De top is doorzichtig, heeft een hoge neklijn en een laag uitgesneden rug. De rok is wijdvallend met een sleep en is gemaakt van tulle.", MinPrijs = 2250, MaxPrijs = 2500, Neklijn = "Hoge neklijn", Silhouette = "Princess model", Stijl = "Prinses Bruid" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12746a" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12746b" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12746c" },

                 jurk = new Jurk { Artikelnummer = 12695, Merk = "Maggie Sottero", Omschrijving = "Trouwjurk van het merk Maggie Sottero gemaakt van organza. De hals is strapless met een sweetheart lijn. De top is afgewerkt met kant. De rok is wijdvallend met een sleep en is verwerkt in ruches.", MinPrijs = 2000, MaxPrijs = 2250, Neklijn = "Strapless", Silhouette = "Princess model", Stijl = "Kant" },
                  new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12695a" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12695b" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12695c" },

                 jurk = new Jurk { Artikelnummer = 12925, Merk = "Eddy K.", Omschrijving = "Trouwjurk van het merk Eddy K. gemaakt van kant. De top is strapless met een lichte sweetheart lijn. De rok heeft een fishtail model met een sleep.", MinPrijs = 1750, MaxPrijs = 2000, Neklijn = "Strapless", Silhouette = "Fishtail", Stijl = "Kant" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12925a" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12925b" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12925c" },

                 jurk = new Jurk { Artikelnummer = 12627, Merk = "Ladybird", Omschrijving = "Trouwjurk van het merk Ladybird gemaakt van organza. De top heeft doorzichtige schouderbanden en een laag uitgesneden rug, beide afgewerkt met gekleurde kanten applicaties. De taille wordt geaccentueerd door een gekleurde riem, drapperie en kanten applicaties. De jurk heeft een A-lijn met sleep en kan gepast worden in de sand kleur.", MinPrijs = 1250, MaxPrijs = 1500, Neklijn = "Schouderbandjes", Silhouette = "A-lijn", Stijl = "Kleurrijke Bruid" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12627a" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12627b" },
                 new Afbeelding { Jurk = jurk, Pak = null, SourcePath = "/12627c" }
                );
        }
    }
}
